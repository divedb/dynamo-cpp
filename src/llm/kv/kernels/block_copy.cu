...
// ---------------------------------------------------------------------------
// dynamo-cpp additions to the vendored reference (device allocation; the
// Rust workspace obtains device memory through cudarc instead). See
// llm/kv/kernels/block_copy.h for the full ABI contract.
// ---------------------------------------------------------------------------

extern "C" int
cuda_malloc_device(void** ptr, size_t size)
{
